...
define('_MB_ISTATS_MAX_WEEKCOUNT','Hits'); 
define('_MB_ISTATS_MAX_MTH','Best Month'); 
define('_MB_ISTATS_MAX_MTHCOUNT','Hits'); 
define('_MB_ISTATS_TOTAL_DAYS','Total Days'); 
...
define("_MB_ISTATS_WELCOME", "Welcome"); 
