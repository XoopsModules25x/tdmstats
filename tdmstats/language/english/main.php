...
define ( '_AM_DATE_VISITS', 'Hits'); 
define ( '_AM_DATE_PERCENT', 'Percent');

 // text of "Visits by week" section
define ( '_AM_WEEK_WEEK', 'Week'); 
define ( '_AM_WEEK_VISITS', 'Hits'); 

// Text of "Visits by month" section 
define ( '_AM_MTH_MTH', 'Month'); 
define ( '_AM_MTH_VISITS', 'Hits'); 

// Text of "Visits by Referer" section 
define ( '_AM_REF_VISITS', 'Hits'); 
define ( '_AM_REF_PERCENT', 'Percent'); 
define ( '_AM_REF_REF', 'Contact');

 // text of "Visits by hour" section
define ( '_AM_HR_HOUR', 'Time'); 
define ( '_AM_HR_VISITS', 'Hits');
define('_AM_VS', 'vs');

 // text of "Visits by week-days" section
define ( '_AM_WD_1', 'Monday'); 
define ( '_AM_WD_2', 'Tuesday'); 
define ( '_AM_WD_3', 'Wednesday'); 
define ( '_AM_WD_4', 'Thursday'); 
define ( '_AM_WD_5', 'Friday'); 
define ( '_AM_WD_6', 'Saturday'); 
define ( '_AM_WD_7', 'Sunday'); 

// Text of "Visits by pages" section 
define ( '_AM_P_VISITS', 'Hits'); 
define ( '_AM_P_PERCENT', 'Percent'); 
define ( '_AM_P_PAGE', 'Total Pages'); 
...
define ( 'AM_SO_FARE', 'visitors at the moment, your site should reach');
...
define('_AM_P_LE',       'The');
//version 1.7
define('_AM_BY_USER',  'Users');
define('_AM_BY_TODAY_USER',  'Users Today');
define('_AM_P_A',       'At');
