...
// text of  stats topic
define('_AM_BY_TODAY_HOUR', 'Trafic du Jour');
...
define('AM_SO_FAR', 'visiteurs pour le moment.');
define('AM_SO_FARE', 'Votre site devrait atteindre');
define('AM_PAGE_VIEW', 'page(s) consult&eacute;e(s).');

//perm
define('_AM_QUERYNOPERM', "Vous n'avez pas les permissions pour &#233fectuer cette action");

//Version 1.6
define('_AM_VIEW', 'Afficher le tableau');
define('_AM_P_LE', 'Le');
//version 1.7
define('_AM_BY_USER', 'Utilisateurs');
define('_AM_BY_TODAY_USER', 'Temps passé Aujourd\'hui');
