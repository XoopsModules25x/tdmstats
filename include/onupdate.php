 ...
 */
function xoops_module_pre_update_tdmstats(XoopsModule $module)
{
...
function xoops_module_update_tdmstats(XoopsModule $module, $previousVersion = null)
{
    $moduleDirName = basename(dirname(__DIR__));
    ...
    /** @var Tdmstats\Helper $helper */
    /** @var Tdmstats\Utility $utility */
    /** @var Tdmstats\Configurator $configurator */
    $helper  = Tdmstats\Helper::getInstance();
    $utility = new Tdmstats\Utility();
    $configurator = new Tdmstats\Configurator();

    if ($previousVersion < 240) {
        //rename column EXAMPLE
        $tables     = new Tables();
        $table      = 'tdmstatsx_categories';
        $column     = 'ordre';
        $newName    = 'order';
